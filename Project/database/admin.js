...
router1.get('/admin1.0', async (req, res) => {   
...
router1.get('/admin1.1', async (req, res) => {   
    console.log("request",  req);
...
router1.get('/admin1.2', async (req, res) => {   
    console.log("request",  req);
...
router1.get('/admin2', async (req, res) => {   
    console.log("request",  req);
...
router1.get('/admin2.1', async (req, res) => {   
    console.log("request",  req);
...
router1.get('/admin3.1', async (req, res) => {   
    console.log("request",  req);
...
router1.get('/admin3.2', async (req, res) => {   
    console.log("request",  req);
...
router1.get('/admin3.3', async (req, res) => {   
    console.log("request",  req);
...
router1.get('/admin3.4', async (req, res) => {   
    console.log("request",  req);
...
router1.get('/admin4.1', async (req, res) => {   
    console.log("request",  req);
...
router1.get('/admin4.2', async (req, res) => {   
    console.log("request",  req);
...
router1.get('/admin4.3', async (req, res) => {   
    console.log("request",  req);
...
router1.get('/admin5.1', async (req, res) => {   
    console.log("request",  req);
...
router1.get('/admin5.2', async (req, res) => {   
    console.log("request",  req);
